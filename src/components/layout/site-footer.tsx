...
export function SiteFooter({ schoolName = "Website Profil Sekolah" }: SiteFooterProps) {
  return (
    <footer className="mt-auto border-t border-slate-200 dark:border-white/5 bg-slate-50 dark:bg-slate-950 text-slate-600 dark:text-slate-400">
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-3">
          <div className="space-y-4">
            <h3 className="font-heading text-lg font-bold text-slate-900 dark:text-white tracking-tight flex items-center gap-2">
              <span className="h-6 w-6 rounded-md bg-gradient-to-br from-indigo-500 to-sky-400 flex items-center justify-center text-[10px] shadow-sm">
                🏫
              </span>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/programs" className="hover:text-indigo-600 dark:hover:text-indigo-300 transition-colors">
                  Program Studi & Fasilitas
                </Link>
              </li>
              <li>
                <Link href="/announcements" className="hover:text-indigo-600 dark:hover:text-indigo-300 transition-colors">
                  Pengumuman Terbaru
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-4">
            ...
            <div className="pt-1">
              <Link
                href="/kontak"
                className="inline-flex items-center justify-center rounded-lg bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 px-4 py-2 text-xs font-semibold tracking-wide text-slate-700 dark:text-white shadow-sm dark:shadow-none hover:bg-slate-50 dark:hover:bg-white/10 transition-all hover:border-indigo-500 dark:hover:border-sky-400"
              >
                Hubungi Kami &rarr;
              </Link>
            </div>
