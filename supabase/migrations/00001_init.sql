-- ============================================================
-- Migration 00001: Initial Schema — Website Profil Sekolah
-- ============================================================
...
-- School profile is singleton — only one row
...
create table if not exists school_narrative (
  id        uuid primary key default gen_random_uuid(),
  history   jsonb not null default '[]'::jsonb, -- array of paragraphs
  vision    text not null default '',
  mission   jsonb not null default '[]'::jsonb  -- array of items
);
...
create table if not exists media_items (
  ...
  album       text not null default '', -- album category slug
  uploaded_at timestamptz not null default now()
);
